...
* Keys
I use one of the /standard hooks/ to delay setting the key maps,
since the =map= function isn't available at the point of loading.
This is because of the tangled Org-mode config,
...
[2020-07-07 Tue]
Nu uitgezet.
Dat lijkt goed te gaan, vooralsnog.

Je kunt ze wel [[https://stackoverflow.com/a/5058752][naar een apart bestand verplaatsen (StackOverflow)]] blijkbaar.
Dat heb ik nu gedaan, naar =~/.doom.d/custom_system.el=
* Disabled
#+begin_example elisp
